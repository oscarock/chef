            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="float-right">
                        <a href="#" v-on:click.prevent="stateHero(superhero.id,'like')"><i class="fas fa-thumbs-up"></i></a>&nbsp;&nbsp;
                        <a href="#" v-on:click.prevent="stateHero(superhero.id,'dontlike')"><i class="fas fa-thumbs-down"></i></a>
                    </div>
